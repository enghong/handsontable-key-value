...
var _Handsontable$dom = Handsontable.dom,
  ...
  _createClass(KeyValueEditor, [{
    ...
    value: function setValue(value) {
      ...
      if (this.state === 'STATE_EDITING') {
        ...
        getDisplayValue.call(this.cellProperties, columnSettings.source, columnSettings.keyProperty, columnSettings.valueProperty, value, function (displayValue) {
